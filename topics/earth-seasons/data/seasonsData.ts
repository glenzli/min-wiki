...
import { solarGeometry } from '../physics/solarGeometry.ts';
...
export const SOLAR_TERMS = [
  {
    ...
    dayOfYear: 80,
    approxDate: t("3月21日前后"),
    subsolarLat: 0.0,
    quickFact: t("春分到啦！太阳直射赤道，大多数地方昼夜大致等长；极点附近情况不同。"),
    academicFact: t("太阳位于黄道与赤道升交点（春分点，赤经 0h），太阳赤纬 δ=0°。理想晨昏圈经过南北极，地轴方向保持不变。")
  },
  {
    id: 'summer_solstice',
    displayName: t("夏至"),
    ...
    fractionOfYear: 0.25,
    dayOfYear: 172,
    approxDate: t("6月21日前后"),
    subsolarLat: 23.44,
    quickFact: t("夏至到了！太阳直射北半球北回归线，北半球白天最长；北极全天都是白天（极昼）！"),
    academicFact: t("太阳赤纬达到北向极值 δ=+23.44°。北极圈（66.5°N以上）出现极昼，南极圈（66.5°S以上）出现极夜。")
  },
  {
    id: 'autumn_equinox',
    displayName: t("秋分"),
    ...
    fractionOfYear: 0.50,
    dayOfYear: 266,
    approxDate: t("9月23日前后"),
    subsolarLat: 0.0,
    quickFact: t("秋风送爽！太阳再次直射赤道，大多数地方昼夜再次大致等长。候鸟开始飞往南方过冬。"),
    academicFact: t("太阳穿过降交点（秋分点，赤经 12h），太阳赤纬回到 δ=0°。正午太阳高度角与春分相同。")
  },
  {
    id: 'winter_solstice',
    displayName: t("冬至"),
    ...
    fractionOfYear: 0.75,
    dayOfYear: 356,
    approxDate: t("12月22日前后"),
    subsolarLat: -23.44,
    quickFact: t("冬至夜最长！太阳跑到南回归线，北半球黑夜最漫长、白天最短；北极全天陷入黑夜（极夜）！"),
    academicFact: t("太阳赤纬达到南向极值 δ=-23.44°。北半球正午太阳高度角达到全年最低，南半球正值盛夏。")
  }
];
...
export const MAJOR_CITIES = [
  {
    ...
    lon: 116.4,
    country: t("中国"),
    desc: t("北温带典型季风气候，四季分明。夏至白昼近 15 小时，冬至白昼仅 9 小时。")
  },
  {
    id: 'london',
    displayName: t("伦敦"),
    ...
    lon: -0.1,
    country: t("英国"),
    desc: t("高纬度温带海洋气候。夏至晚上 10 点天色仍亮（白天近 16.5 小时），冬至下午 4 点已入夜。")
  },
  {
    id: 'new_york',
    displayName: t("纽约"),
    ...
    lon: -74.0,
    country: t("美国"),
    desc: t("与北京纬度相近（约 40°N），地方太阳时相差约 13 小时（北京正午时纽约正值深夜入眠）。")
  },
  {
    id: 'sydney',
    displayName: t("悉尼"),
    ...
    lon: 151.2,
    country: t("澳大利亚"),
    desc: t("南半球大都市！季节与北半球完全颠倒：12月盛夏过圣诞节，6月进入冬季。")
  },
  {
    id: 'equator',
  ...
  },
  {
    ...
    lon: 0.0,
    country: t("北冰洋极地"),
    desc: t("终年冰雪覆盖。一年只有一次日出和日落：半年是连续白昼（极昼），半年是连续黑夜（极夜）。")
  }
];
 ...
 */
export function calcSubsolarLatitude(fractionOfYear: number, tiltDeg = EARTH_CONSTANTS.axialTiltDeg) {
 ...
 */
export function calcNoonSolarAltitude(latDeg: number, subsolarLatDeg: number) {
 ...
 */
export function calcDaylightHours(latDeg: number, subsolarLatDeg: number) {
 ...
 */
export function calcSolarHeatFlux(altitudeDeg: number) {
