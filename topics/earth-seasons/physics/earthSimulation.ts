...
export class EarthSimulation {
  ...
  orbitCurveGroup!: THREE.Group<THREE.Object3DEventMap>;
  earthAnchorGroup!: THREE.Group<THREE.Object3DEventMap>;
  axialTiltGroup!: THREE.Group<THREE.Object3DEventMap>;
  earthSpinGroup!: THREE.Group<THREE.Object3DEventMap>;
  beamGroup!: THREE.Group<THREE.Object3DEventMap>;
  textureLoader!: THREE.TextureLoader;
  dayTexture!: THREE.Texture;
  nightTexture!: THREE.Texture;
  cloudsTexture!: THREE.Texture;
  ambientLight!: THREE.AmbientLight;
  sunDirectional!: THREE.DirectionalLight;
  stars!: THREE.Points<THREE.BufferGeometry<THREE.NormalBufferAttributes>, THREE.PointsMaterial, THREE.Object3DEventMap>;
  sunMesh!: THREE.Mesh<THREE.SphereGeometry, THREE.MeshBasicMaterial, THREE.Object3DEventMap>;
  sunCorona!: THREE.Mesh<THREE.SphereGeometry, THREE.ShaderMaterial, THREE.Object3DEventMap>;
  orbitRadius!: number;
  orbitLine!: THREE.LineLoop<THREE.BufferGeometry<THREE.NormalBufferAttributes>, THREE.LineBasicMaterial, THREE.Object3DEventMap>;
  earthMaterial!: THREE.ShaderMaterial;
  earthMesh!: THREE.Mesh<THREE.SphereGeometry, THREE.ShaderMaterial, THREE.Object3DEventMap>;
  cloudsMesh!: THREE.Mesh<THREE.SphereGeometry, THREE.MeshStandardMaterial, THREE.Object3DEventMap>;
  guidesGroup!: THREE.Group<THREE.Object3DEventMap>;
  citiesGroup!: THREE.Group<THREE.Object3DEventMap>;
  cityMeshMap!: Map<string, {city: (typeof MAJOR_CITIES)[number]; mesh: THREE.Mesh<THREE.SphereGeometry, THREE.MeshBasicMaterial>}>;
  subsolarRing!: THREE.Mesh<THREE.RingGeometry, THREE.MeshBasicMaterial, THREE.Object3DEventMap>;
  directBeamLine!: THREE.Line<THREE.BufferGeometry<THREE.NormalBufferAttributes>, THREE.LineBasicMaterial, THREE.Object3DEventMap>;
  slantBeamLine!: THREE.Line<THREE.BufferGeometry<THREE.NormalBufferAttributes>, THREE.LineBasicMaterial, THREE.Object3DEventMap>;
  illumination!: { orbit: { x: number; y: number; z: number; }; sunWorld: { x: number; y: number; z: number; }; sunLocal: { x: number; y: number; z: number; }; declination: number; };
  ...
  initGuides() {
    ...
    const createLatRing = (latDeg: number, colorHex: number, opacity: number, dash = false) => {
  ...
  setSolsticeTerm(fractionOfYear: number) {
