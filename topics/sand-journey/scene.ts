...
export function draw(p:number,condition:number){
 ...
 const rock=`<path d="M93 284L108 210L165 174L218 190L248 244L219 288Z" fill="#9da9a0" stroke="#74867a" stroke-width="3"/><path d="M165 174L150 237L93 284L108 210Z" fill="#b5b8a7"/><path d="M150 237L218 190L248 244L219 288Z" fill="#7e9087"/><path d="M165 174L150 237L93 284M150 237L218 190M150 237L219 288" stroke="#ccd1bd" stroke-width="3" fill="none"/>`;
 const shell=`<g transform="translate(176 235)"><path d="M-62 6Q-86-57-48-72Q-25-107 0-84Q33-107 51-70Q86-52 59 10L13 55H-13Z" fill="#eedac0" stroke="#bf9f86" stroke-width="3"/>${[-50,-30,0,30,50].map(x=>`<path d="M0 49Q${x/2} -7 ${x} -65" fill="none" stroke="#d1b197" stroke-width="3"/>`).join('')}<path d="M-13 54L-20 71H21L13 54" fill="#dec2a3" stroke="#bf9f86" stroke-width="2"/></g>`;
 ...
 const sourceOpacity=stage===0?1:.55,fragOpacity=stage===1?1:.45;
 ...
 const [x,y]=pos;
 return {labels:[condition===0?t('岩石来源'):t('生物硬结构来源'),t('沙子有不同颜色和成分'),t('长长的时间被压缩了')],scene:`<defs><linearGradient id="bg" x2="0" y2="1"><stop stop-color="#e5efea"/><stop offset="1" stop-color="#f7ecd2"/></linearGradient><linearGradient id="ocean" x2="0" y2="1"><stop stop-color="#91ced0"/><stop offset="1" stop-color="#4f9fab"/></linearGradient></defs>
 <rect x="24" y="24" width="802" height="484" rx="26" fill="url(#bg)"/>
 <circle cx="734" cy="101" r="33" fill="#f1d788"/>
 <path d="M25 279Q157 285 232 310T457 293Q568 249 651 264T826 279V508H25Z" fill="#d8c9a0"/>
 <path d="M495 263Q586 229 651 264T826 279V508H715Q742 451 679 419Q722 379 648 338Q610 294 495 263Z" fill="url(#ocean)"/>
 <path d="M494 263Q613 292 649 338Q725 379 679 419Q741 451 715 508" fill="none" stroke="#ecf4e0" stroke-width="12" opacity=".8"/>
 ...
 <g opacity="${sourceOpacity}">${condition===0?rock:shell}</g><g opacity="${fragOpacity}">${fragments}</g><g opacity="${stage===3?1:.5}">${tiny}</g>
 ...
 ${stage>=1?`<g transform="translate(${x} ${y})"><circle r="24" fill="#fff9dc" stroke="#d0a44e" stroke-width="3"/><path d="M-7-6L5-9L10 1L3 10L-9 4Z" fill="${condition===0?'#bcb69a':'#e1bd9d'}"/></g>`:''}
