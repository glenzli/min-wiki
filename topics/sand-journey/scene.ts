...
export function draw(p:number,condition:number){
 ...
 ${`<g transform="translate(${x} ${y})"><circle r="24" fill="#fff9dc" stroke="#d0a44e" stroke-width="3"/><path d="M-7-6L5-9L10 1L3 10L-9 4Z" fill="${condition===0?'#bcb69a':'#e1bd9d'}"/></g>`}
