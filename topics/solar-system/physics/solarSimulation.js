import { orbitalState } from './orbits.js';
...
export class SolarSimulation {
  ...
  setCameraView(viewName, planetId = null) {
    this.activeView = viewName;
    this.cameraTransition = true;
    if (planetId) this.selectedPlanetId = planetId;
    if (this.viewMode === 'lineup') {
      const node = viewName === 'follow' ? this.planetNodes.get(this.selectedPlanetId) : null;
