...
export const SUN_DATA = {
  ...
  symbol: '☉',
  type: 'star',
  typeName: t("黄矮星 (G2V 主序恒星)"),
  typeZh: t("黄矮星 (G2V 主序恒星)"),
  radiusKm: 696340,
  diameterKm: 1392680,
  ...
  coreTempC: 15000000,
  colorHex: '#ffaa22',
  kidFact: t("太阳是太阳系里唯一的发光大火球！它占了整个太阳系 99.86% 的总重量，肚子里能装下整整 130 万个地球！"),
  quickFact: t("太阳是太阳系里唯一的发光大火球！它占了整个太阳系 99.86% 的总重量，肚子里能装下整整 130 万个地球！"),
  academicNote: t("太阳系绝对的引力主导中心。通过核心热核聚变（质子-质子链反应）辐射能量，提供行星运动所需的引力势阱与辐射平衡。"),
  academicFact: t("太阳系绝对的引力主导中心。通过核心热核聚变（质子-质子链反应）辐射能量，提供行星运动所需的引力势阱与辐射平衡。")
};
...
const planets = [
  {
    ...
    rings: false,
    kidFact: t("溜冰冠军水星！它是离太阳最近的小朋友，跑得最快（88天就过完一年），但因为没有大气棉被，白天400多度能烤肉，晚上零下一百多度！"),
    academicNote: t("水星处于强引力场中，爱因斯坦广义相对论的经典实验验证之一便是解释其每百年 43 角秒的反常近日点进动。无显著稠密大气。")
  },
  {
    id: 'venus',
    index: 2,
    ...
    rings: false,
    kidFact: t("倒着转的明亮金星！天空中除了太阳和月亮最亮的就是它。它裹着厚厚的黄色浓硫酸云被子，自己倒着慢慢转，太阳从西边升起！"),
    academicNote: t("失控温室效应的极端典型。厚达数十公里的二氧化碳与硫酸云层导致地表气压高达 92 个地球大气压，平均表面温度高达 465°C。")
  },
  {
    id: 'earth',
    index: 3,
    ...
    hasMoon: true,
    moonRadiusKm: 1737.4,
    kidFact: t("我们最温暖美丽的蓝色家园！拥有清澈的大海、绿色森林、氧气和可爱的月亮伙伴，是太阳系里唯一的生命大摇篮！"),
    academicNote: t("处于太阳系宜居带（Goldilocks Zone）正中。具有稳定的氮氧大气层、全球性偶极磁场、板块构造与丰富液态水圈，维系复杂碳基生命演化。")
  },
  {
    id: 'mars',
    index: 4,
    ...
    rings: false,
    kidFact: t("红彤彤的沙漠侦探星！土壤里富含生锈的氧化铁，两极顶着白雪般的水冰与干冰帽。人类派去了好多辆火星车在上面探险呢！"),
    academicNote: t("拥有全太阳系最高的火山（奥林匹斯山，高约 21 km）和最长峡谷（水手号峡谷）。虽大气稀薄，但拥有古河流三角洲冲积证据。")
  },
  {
    id: 'jupiter',
    index: 5,
    ...
    rings: false,
    hasSpot: true,
    kidFact: t("太阳系的巨无霸大队长！它个头大到能装进 1300 多个地球！肚子上还有个吹了300多年的大红斑风暴，比两个地球还要大！"),
    academicNote: t("质量是太阳系其他所有行星总质量的 2.5 倍。成分以氢、氦为主，巨大的自转速度驱动纬向喷流带与大红斑（反气旋风暴）。")
  },
  {
    id: 'saturn',
    index: 6,
    ...
    ringInnerRatio: 1.25,
    ringOuterRatio: 2.30,
    kidFact: t("戴着全宇宙最漂亮金光草帽的明星！壮丽的光环其实是由无数亮晶晶的碎冰块和小岩石排着队构成的，闪闪发光！"),
    academicNote: t("平均密度仅约 0.69 g/cm³（唯一低于水密度的行星）。光环处于洛希极限之内，强烈潮汐剪切阻止了冰雪残骸聚集成单一卫星。")
  },
  {
    id: 'uranus',
    index: 7,
    ...
    ringInnerRatio: 1.6,
    ringOuterRatio: 1.95,
    kidFact: t("调皮的“躺平打滚星”！别的星球都是像陀螺一样立着转，天王星却躺得平平的（倾斜98度），像个保龄球一样沿着轨道向前滚！"),
    academicNote: t("富含水、氨、甲烷冰质物质的冰巨星。其异常极端的近 98° 自转轴倾角，被普遍认为是太阳系早期遭受原行星巨型侧撞击的结果。")
  },
  {
    id: 'neptune',
    index: 8,
    ...
    rings: false,
    kidFact: t("守在太阳系大门最远处的蔚蓝大巨人！阳光要走4个多小时才能跑到它那里。上面刮着全太阳系最凶猛的高速狂风！"),
    academicNote: t("绕日一周需地球时间近 165 年。甲烷强烈吸收红光赋予其深邃宝石蓝外观，内部热源驱动了时速超过 2,100 km/h 的超音速大气狂风。")
  }
];

export const PLANETS_DATA = planets.map(p => ({...p, displayName: p.name, nameEn: p.englishName, typeZh: p.typeName, quickFact: p.kidFact, academicFact: p.academicNote}));
export type Planet = (typeof PLANETS_DATA)[number];
...
export function getVisualOrbitRadius(semiMajorAxisAU: number) {
...
export function getVisualPlanetRadius(relativeEarthDiameter: number) {
...
export function getTrueScaleLineupRadius(relativeEarthDiameter: number) {
