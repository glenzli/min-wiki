import { clamp, smooth, orbitAt, randomSource, SCENARIOS, MU, HORIZON_RADIUS } from './encounter.js';
...
export function disruptionTime(progress, scenario = 'tidal') {
...
export function cohesiveFraction(progress, detachAt) {
...
export class StellarDisruption {
  ...
  integrateParcel(i, initialStar) {
    ...
    const force = (p, cx, cy, cz, cvx, cvy, cvz) => {
  ...
  sample(progress, positions, previous, state) {
