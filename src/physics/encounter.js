...
export const SCENARIOS = {
  free: { duration: 48, noBlackHole: true },
...
export function motionProgress(progress, scenario) {
...
export function playbackProgress(motion, scenario) {
...
export function orbitAt(progress, scenario = 'flyby') {
...
export class Playback {
  ...
  seek(progress) { this.progress = clamp(progress); }
  tick(delta) {
